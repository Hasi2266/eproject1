        ...
        <ul class="nav nav-sidebar " style="margin-top:1rem">
          ...
          <li class="nav-item show">
            <a href="<?php echo base_url();?>index.php/ClientDashboard" class="nav-link   <?php if($active == 1){ echo 'active';}else{ echo 'no';}?>"><i data-feather="box" class="nav-icon-color"></i> Dashboard</a>
					...
					<li class="nav-item">
            <a href="Project-page.html" class="nav-link with-sub <?php if($active == 2){ echo 'active';}else{ echo 'no';}?>"><i data-feather="file-text" class="nav-icon-color"></i> Poject</a>
            <nav class="nav nav-sub">
              ...
              <a href="<?php echo base_url();?>index.php/ClientProject/Proposal/" class="nav-sub-link">Proposal</a>
					...
					<li class="nav-item">
            <a href="services-page.html" class="nav-link with-sub <?php if($active == 3){ echo 'active';}else{ echo 'no';}?>"><i data-feather="layout" class="nav-icon-color"></i> Services</a>
            <nav class="nav nav-sub">
              ...
              <!-- <a href="services-page.html" class="nav-sub-link">Services</a> -->
					...
					<li class="nav-item ">
            <a href="packages-page.html" class="nav-link with-sub <?php if($active == 4){ echo 'active';}else{ echo 'no';}?>  "><i data-feather="lock" class="nav-icon-color"></i> Packages</a>
            <nav class="nav nav-sub">
            ...
            <nav class="nav nav-sub">
              ...
              <a href="invoice-table.html" class="nav-sub-link">Invoice List</a>
					...
					<li class="nav-item ">
            <a href="packages-page.html" class="nav-link with-sub <?php if($active == 5){ echo 'active';}else{ echo 'no';}?>  "><i data-feather="book" class="nav-icon-color"></i> User Info</a>
            <nav class="nav nav-sub">
