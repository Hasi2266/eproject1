      ...
      <div class="card card-hover card-projects  card-task-one dashCardHover content-card-body mt-4" style="border-radius: 10px;margin-bottom:2rem !important;padding-bottom:3rem; " >
        ...
        <table id="example1" class="table1 table " style="border-radius:10px ;font-size:13px;">
          <thead>
            <tr>
              <!-- <th class="wd-12p"><div class="custom-control custom-checkbox" style="border-radius: 8px;">
				...
				<th></th>
              <th class="wd-20p"><span style="margin-left:-2.5rem;">Invoice Number</span></th>
          ...
          <tbody>
				...
				<tr data-url="<?php echo base_url()?>index.php/ClientInvoice/updateInvoice/<?php echo $item->invoice_id ?>" style="cursor:pointer;">
				...
				<td></td>
				<td><span style="margin-left:-2.5rem;"><?php echo $item->invoice_no?></span></td>
