          ...
          <tbody>
           <?php  foreach($milestones as $item){?>
			...
			<?php if ((($project->add_proposal)== 1) && (($project->approve_project)== 1) && (($project->start_project) == 0) && (($project->end_project) == 0) ) { ?>
				...
				<a href="<?php echo base_url();?>index.php/AdminProject/startProject/<?php echo $project->project_id?>"><button type ="button" class="btn btn-primary">Start Project</button></a>
				<a href="<?php echo base_url();?>index.php/AdminProject/"></a><button type="submit" class="btn btn-primary">Cancel</button>

			<?php } else if((((($project->start_project) == 1) && ($project->hold_project) == 0) && ($project->end_project) == 0)) {  ?>

				<a href="<?php echo base_url();?>index.php/AdminProject/endProject/<?php echo $project->project_id?>"><button type ="button" class="btn btn-primary">End Project</button></a>
				<a href="<?php echo base_url();?>index.php/AdminProject/holdProject/<?php echo $project->project_id?>"><button type ="button" class="btn btn-primary">Hold Project</button></a>
				<a href="<?php echo base_url();?>index.php/AdminProject/"></a><button type="submit" class="btn btn-primary">Cancel</button>

			<?php } else if (((($project->start_project) == 1) && ($project->hold_project) == 1)) { ?>

				<a href="<?php echo base_url();?>index.php/AdminProject/startAgainProject/<?php echo $project->project_id?>"><button type ="button" class="btn btn-primary">Start Again Project</button></a>
				<a href="<?php echo base_url();?>index.php/AdminProject/endProject/<?php echo $project->project_id?>"><button type ="button" class="btn btn-primary">End Project</button></a>
			...
			<?php } else if ((($project->start_project)== 0) && (($project->end_project) == 1)){?>
				...
				<a href="<?php echo base_url();?>index.php/AdminProject/"><button type ="button" class="btn btn-primary">Back</button></a>
			<?php } else { ?>
				<button type="submit" class="btn btn-primary mt-4">Submit Proposal</button>
				<a href="<?php echo base_url();?>index.php/AdminProject/"></a><button type="submit" class="btn btn-primary mt-4">Cancel</button>
