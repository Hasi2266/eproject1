				...
				<div class="card-header bg-transparent pd-y-15 pd-l-15 pd-r-10" style="margin-bottom:-0.1rem;">
					...
					<?php foreach($teams as $team){?>
                            ...
                            <div class="col-md-6 ">
                                ...
                                <input type="text" value = "<?php echo $team->name?>" name="name" class="form-control  py-2 service-input-box" style="border-radius:8px">
                            </div>
                            <div class="col-md-6 mg-t-10 mg-sm-t-0 rounded ">
                                <label for="inputEmail4" class="form-label">Parent</label>
                                <input type="text " value = "<?php echo $team->parent_category?>" class=" form-control py-2 service-input-box" name="parent_category" style="border-radius:8px">
                            </div>
