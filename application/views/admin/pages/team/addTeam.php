        ...
        <div class="row row-xs " style="margin: 20px 100px 0px 100px;">
            <div class=" col-md-12">
                <div class="component-section no-code ">
                    <form action="<?php echo base_url();?>index.php/AdminTeam/saveTeam" method="post" class="bg-white shadow category-form border ">
					<h5 id="section1" class="tx-semibold p-4">Add Team</h5>
					<div class="row row-sm row-md justify-content-around px-4 pt-5">
                            <div class="col-md-6 ">
