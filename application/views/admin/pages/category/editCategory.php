	...
	<div class="card card-hover card-projects  card-task-one dashCardHover content-card-body mt-4" style="border-radius: 10px;margin-bottom:2rem !important;padding-bottom:3rem; " >
        <!--btn-->
				<div class="card-header bg-transparent pd-y-15 pd-l-15 pd-r-10" style="margin-bottom:-0.1rem;">
                    ...
                    <form action="<?php echo base_url();?>index.php/AdminCategory/updateItem" method="post">
					...
					<?php foreach($items as $item){?>
						...
						<input type="hidden" name="category_id" value="<?php echo $item->category_id?>">
                            <div class="col-md-6 ">
                                ...
                                <input type="text" name="name" value = "<?php echo $item->name?>" class="form-control  py-2 service-input-box" style="border-radius:8px">
                            </div>
                            <div class="col-md-6 mg-t-10 mg-sm-t-0 rounded ">
                                <label for="inputEmail4" class="form-label">Parent Category</label>
                                <input type="text "  value = "<?php echo $item->parent_category?>" class=" form-control py-2 service-input-box" name="parent_category" style="border-radius:8px">
                            </div>
