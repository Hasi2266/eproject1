<div class="content-header">
        ...
        <div class="pd-x-65 pd-b-15">
            ...
            <div class="row">
                <div class="px-3 " style="margin-left:63rem;">
                    <a href="<?php echo base_url();?>index.php/AdminCategory/addCategory"><button type="button" class="btn btn-all text-white  py-2 "style="border-radius: 8px;">Add New Category</button></a>
                </div>
                <!-- <div class="">
        ...
        <!--btn-->
				<div class="card-header bg-transparent pd-y-15 pd-l-15 pd-r-10" style="margin-bottom:-0.1rem;">
									<h6 class="card-title mg-b-0 px-1" style="margin-top:1px;margin-bottom:-6px">Categories</h6>
									<!-- <nav class="nav">
					...
					<!-- data-url="<?php echo base_url()?>index.php/AdminTeam/editTeam/<?php echo $item->team_id ?> -->
						...
						?> -->
							...
							<td><?php echo $item->parent_category?></td>
                           	<td>
								<a href="<?php echo base_url();?>index.php/AdminCategory/editItem/<?php echo $item->category_id?>"><button type="submit" class="btn btn-submit py-1 px-2">Update</button></a>
								<a href="<?php echo base_url();?>index.php/AdminCategory/deleteItem/<?php echo $item->category_id?>"><button type="submit" class="btn btn-submit py-1 px-2 mx-1" data-toggle="modal" data-animation="effect-just-me" >Delete</button></a>
