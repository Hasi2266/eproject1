      ...
      <div class="col-md-5 signin-sidebar">
        <div class="signin-sidebar-body">
          ...
          <h5 class="signin-subtitle">Please signin to continue.</h5>
			...
			<form action="<?php echo base_url();?>index.php/Admin/userLogin" method="post">
          <div class="signin-form">
            ...
            <div class="form-group d-flex mg-b-0">
              ...
              <a href="<?php echo base_url();?>index.php/Admin/signUp" class="btn btn-white btn-uppercase flex-fill mg-l-10">Sign Up</a>
            </div>
